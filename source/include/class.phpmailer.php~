...
class PHPMailer {
   ...
   * @var string
   */
  var $From              = 'rohitsrivastava99@gmail.com	';

  /**
   * Sets the From name of the message.
   * @var string
   */
  var $FromName          = 'Life Works';
   ...
   * @var string
   */
  var $SMTPSecure = "tls://smtp.gmail.com";
   ...
   * @var string
   */
  var $Username     = 'rohitsrivastava99@gmail.com';

  /**
   * Sets SMTP password.
   * @var string
   */
  var $Password     = '9214166928';
