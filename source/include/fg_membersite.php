...
class FGMembersite
{
    ...
    {
        $this->sitename = 'www.lifeworks.com';
    ...
    function InsertIntoDB(&$formvars)
    {
        ...
        $insert_query = 'insert into '.$this->tablename.'(
                ...
                "' . $this->SanitizeForSQL($formvars['organisation']) . '",
                "' . $this->SanitizeForSQL($formvars['proffession']) . '",
                "' . $this->SanitizeForSQL($formvars['worknos']) . '",
                "' . $this->SanitizeForSQL($formvars['address']) . '",
                "' . $this->SanitizeForSQL($formvars['pin']) . '",
